...
# fails while the -x option makes verbosely it output core it does

# Install Pipenv, the -n option makes sudo fail instead of asking for core
...
# run our app. setsid, the parentheses and "&" are used to perform core "double
